...
public interface CardTransactionRepository extends JpaRepository<CardTransactions, Long> {
    ...
    CardTransactions findByRemitaRequestIdAndMandateIdAndStatusInAndTransactionDate(String requestId, String mandateId, List<String> status, LocalDate LastUpdateDate);
